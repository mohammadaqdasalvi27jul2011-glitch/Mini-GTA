    ...
    def get_image(cls, path, width=None, height=None, fallback_color=WHITE):
        ...
        try:
            if not os.path.exists(path):
                ...
                surface = pygame.Surface((width or 40, height or 40), pygame.SRCALPHA)
...
class Pickup(pygame.sprite.Sprite):
    ...
    def update(self):
        try:
            ...
            print(f"Error in Pickup.update(): {e}")
...
class Vehicle(pygame.sprite.Sprite):
    ...
    def handle_input(self, keys):
        try:
            ...
            print(f"Error in Vehicle.handle_input(): {e}")
...
class Police(pygame.sprite.Sprite):
    ...
    def update(self, world_width, world_height, player):
        try:
            ...
            print(f"Error in Police.update(): {e}")
...
class Player(pygame.sprite.Sprite):
    ...
    def handle_input(self, keys, mouse_pos):
        try:
            ...
            print(f"Error in Player.handle_input(): {e}")
    ...
    def shoot(self, current_time, bullets):
        try:
            ...
            print(f"Error in Player.shoot(): {e}")
...
class Game:
    def __init__(self):
        try:
            ...
            pygame.display.set_caption("Mini GTA - 4K Enhanced Edition | Play/Debug Mode")
            ...
            print("   1,2,3 - Change Weapons")
            print("   E - Enter Vehicle")
            ...
            print(f"❌ Error in Game.__init__(): {e}")
            raise
    ...
    def create_background(self):
        ...
        try:
            ...
            print(f"❌ Error in create_background(): {e}")
            raise
    ...
    def init_game(self):
        try:
            ...
            print("✅ Game initialized! Vehicles, NPCs, and Police spawned.")
        except Exception as e:
            ...
            if self.player.in_vehicle:
                ...
                for vehicle in self.vehicles:
                    ...
                    if dist < 40:
                        ...
                        print(f"🚗 Entered {vehicle.vehicle_type.capitalize()}")
                        break
        except Exception as e:
            print(f"❌ Error in try_enter_vehicle(): {e}")
    ...
    def save_high_scores(self):
        try:
            ...
            print(f"❌ Error in save_high_scores(): {e}")
    ...
    def load_high_scores(self):
        try:
            ...
            print(f"❌ Error in load_high_scores(): {e}")
            return {"money": 0, "kills": 0}
    ...
    def draw_pause_screen(self):
        try:
            ...
            print(f"❌ Error in draw_pause_screen(): {e}")
        ...
        try:
            ...
            for vehicle in self.vehicles:
                ...
                if -100 < sx < SCREEN_WIDTH + 100 and -100 < sy < SCREEN_HEIGHT + 100:
                    ...
                    if vehicle.health < vehicle.max_health:
                        ...
                        pygame.draw.rect(self.screen, RED, (int(sx - bar_width // 2), int(sy - 30), bar_width, bar_height))
                        pygame.draw.rect(self.screen, GREEN, (int(sx - bar_width // 2), int(sy - 30), int(bar_width * health_ratio), bar_height))
                        pygame.draw.rect(self.screen, WHITE, (int(sx - bar_width // 2), int(sy - 30), bar_width, bar_height), 2)
            ...
            for npc in self.npcs:
                ...
                if -50 < sx < SCREEN_WIDTH + 50 and -50 < sy < SCREEN_HEIGHT + 50:
                    ...
                    if npc.health < npc.max_health:
                        ...
                        pygame.draw.rect(self.screen, RED, (int(sx - bar_width // 2), int(sy - 20), bar_width, bar_height))
                        pygame.draw.rect(self.screen, GREEN, (int(sx - bar_width // 2), int(sy - 20), int(bar_width * health_ratio), bar_height))
            ...
            for pickup in self.pickups:
                ...
                if -30 < sx < SCREEN_WIDTH + 30 and -30 < sy < SCREEN_HEIGHT + 30:
                    ...
                    pygame.draw.circle(self.screen, YELLOW, (int(sx), int(sy)), 30, 1)
            ...
            for bullet in self.bullets:
                ...
                if -20 < sx < SCREEN_WIDTH + 20 and -20 < sy < SCREEN_HEIGHT + 20:
                    ...
                    pygame.draw.line(self.screen, YELLOW if bullet.owner_type == "player" else RED, (int(sx), int(sy)), (int(prev_x), int(prev_y)), 2)
...
if __name__ == "__main__":
    try:
        print("=" * 60)
        print("🎮 MINI GTA - 4K Enhanced Edition")
        print("=" * 60)
        game = Game()
        game.run()
    except Exception as e:
